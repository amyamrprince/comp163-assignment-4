...
# Assignment 4: Student Life Simulator
...
Starting stats are created for GPA, study hours, social points, and stress level.  

Step 2: Course Planning Decision  
Demonstrates if / elif / else and comparison operators (>=, <, ==) by adjusting stats based on course load.  

Step 3: Study Strategy Decision  
Demonstrates membership operators (in, not in) and logical operators (and, or) to validate study choices and apply different outcomes.  
